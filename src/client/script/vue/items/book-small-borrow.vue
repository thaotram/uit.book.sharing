<template>
    <ai-row class="book-small book-small-borrow hasShadow">
...
.book-small-borrow-enter,
.book-small-borrow-leave-to {
    opacity: 0;
    transform: scale(0);
}

.book-small-borrow-enter-to {
    opacity: 1;
    transform: scale(1);
}

.book-small-borrow-move {
    opacity: 1;
    transition: all 0.5s;
}
</style>